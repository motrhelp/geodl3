...
export function calculateDistance(country1, country2) {
    return getDistanceFromLatLonInKm(country1.lat, country1.lon, country2.lat, country2.lon);
}
...
export function calculateBearing(country1, country2) {
    return getBearingFromLatLon(country1.lat, country1.lon, country2.lat, country2.lon);
}
